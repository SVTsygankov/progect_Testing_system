...
//    public static final String RESULT_MAPPER = "resultMapper";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        resultMapper.enable(SerializationFeature.INDENT_OUTPUT);
        resultMapper.registerModule(new JavaTimeModule());
        resultMapper.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
        resultMapper.setVisibility(PropertyAccessor.FIELD, JsonAutoDetect.Visibility.ANY);
        resultMapper.configure(JsonGenerator.Feature.AUTO_CLOSE_TARGET, false);
        resultMapper.configure(JsonParser.Feature.ALLOW_SINGLE_QUOTES, true);
        resultMapper.addMixIn(Result.UserAnswer.class, UserAnswerMixin.class);
        resultMapper.addMixIn(Instant.class, InstantMixin.class);
        ...
        var resultsDao = new ResultDao(resultMapper, resultsFile);
...
//        servletContext.setAttribute(RESULT_MAPPER, resultMapper);
