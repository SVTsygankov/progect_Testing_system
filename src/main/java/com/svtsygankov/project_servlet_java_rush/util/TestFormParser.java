...
public class TestFormParser {
    ...
    public static TestCreationRequest parse(HttpServletRequest req, ObjectMapper objectMapper) throws IOException {
        // Парсим JSON напрямую в DTO
        return objectMapper.readValue(req.getReader(), TestCreationRequest.class);
    }
